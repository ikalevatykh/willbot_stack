...
from willbot_utils.controller import ControllerManager, Controller
...
class UR5(moveit_commander.MoveGroupCommander):
    ...
    def __init__(self, group_name="manipulator", hand=None):
        ...
        self._controller_manger = ControllerManager('arm')
        self._hand = hand
    ...
    def controller(self, name):
        """Returns the arm controller interface."""
        return Controller(self._controller_manger, name)
